...
public class EmployeeController {
    ...
    @GetMapping("/page")
    @ApiOperation("Select employee by name and limit")
    public Result<PageResult> page(EmployeePageQueryDTO employeePageQueryDTO){
        log.info("Employees select with pages");
    ...
    @ApiOperation("disable or enable employee permission")
    public Result permission(@PathVariable Integer status,Long id){
        employeeService.permission(status,id);
        return Result.success();
    }
